...
fn part1(input: &Input) -> u64 {
    ...
    let mut end_file_total_length = input[end_file_index];
    let mut end_file_id = end_file_index / 2;
    let mut end_file_remaining_length = end_file_total_length - end_file_moved_length;
